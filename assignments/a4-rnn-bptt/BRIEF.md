...
## Questions
- [x] **Q1 Forward Pass** — explain processing of (x₁,x₂,x₃); **draw the unrolled
      computational graph** showing dependency flow among xₜ, hₜ, and L
- [x] **Q2 Hidden State Dynamics** — functional role of hₜ; how it accumulates and
      carries context from preceding timesteps
- [x] **Q3 BPTT** — how L backpropagates from h₃ to h₁; why it is called
      *Backpropagation Through Time*
- [x] **Q4 Chain Rule Derivation** — derive explicit analytical ∂L/∂h₁ using the
      multivariable chain rule; **show each step** through h₂ and h₃
- [x] **Q5 Intermediate Activations & Memory** — why h₁,h₂,h₃ must be stored during the
      forward pass for use in the backward pass
- [x] **Q6 Parameter Sharing** — why the same weights are shared across every timestep;
      effect on gradient computation and parameter updates during BPTT
- [x] **Q7 Vanishing & Exploding Gradients** — why gradients exponentially diminish or
      grow over long temporal sequences
- [x] **Q8 PyTorch Implementation** — custom RNN cell/module, sequence of **T ≥ 5**
...
## Classroom (this overrides the PDF, which is silent on format)
**"RNN - Hand Written Assignment."** · 10 pts · **due 28 Aug** · was showing **Missing**
*"Complete the attached assignment and submit a scanned handwritten note."*

## Deliverables
- [x] `writeup/` — Q1–Q7 (Q1 needs a real diagram; Q4 needs full derivation steps)
- [x] Q8 notebook + printed gradient tensors
